function [sys,x0,str,ts] = msinertia(t,x,u,flag,dyn)

%	Función-S correspondiente al bloque "Término de la matriz de masas" para
%	el caso de robots manipuladores con base móvil. 
