...
%	manipuladores con base fija. Está basada fundamentalmente en la función
%	RNES.

%	Copyright (C)	Iván Maza 2001

function [sys,x0,str,ts] = srne(t,x,u,flag,dyn,grav)
...
qdd = u( (2*n+1):(3*n) )';
fext = u( (3*n+1):(3*n+6) );
sys = rnes(dyn, q, qd, qdd, [0;0;0], [0;0;0], [0;0;0], grav, fext)';
